...
import { alertCircleOutline, calendarClearOutline, checkmarkCircleOutline, closeCircleOutline, pencilOutline, pricetagOutline, removeCircle, repeat, trashOutline } from 'ionicons/icons';
...
export class BudgetsPage implements OnInit {
  ...
  constructor() {
    addIcons({ repeat, removeCircle, pricetagOutline, closeCircleOutline, checkmarkCircleOutline, alertCircleOutline, pencilOutline, trashOutline, calendarClearOutline })
  }
